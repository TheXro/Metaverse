...
const ExploreCard = ({ id, imgUrl, index, active, handleClick, title }) => (
  <motion.div
    ...
    flex items-center justify-center min-w-[170px] h-[700px] transition-[flex] duration-[.7s] ease-out-flex cursor-pointer`}
      ...
      (
        <div className="absolute bottom-0 p-8 justify-start
         w-full flex-col bg-[rgba(0,0,0,0.5)] rounded-b-[24px] ">
          ...
          <h2 className="mt-[24] font-semibold sm:text-[32] text-[24px] text-white  " >
            {title}
          </h2>
        </div>
      )
